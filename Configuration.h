...
#define STRING_CONFIG_H_AUTHOR "(Nono, SKR3 2.1.1)" // Who made the changes.
...
//#define BAUD_RATE_GCODE     /115200/ Enable G-code M575 to set the baud rate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.21, 80.21, 400, 412  }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {  17.56, 1.07, -1.95  }
